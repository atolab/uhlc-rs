...
///
/// The first 32-bits part is the number of second since the [`crate::EPOCH`] of the physical clock,
...
impl NTP64 {
    ...
    /// Convert to a [`SystemTime`], using [`crate::EPOCH`] as reference.
    #[inline]
    pub fn to_system_time(self) -> SystemTime {
        *crate::EPOCH + self.to_duration()
    }
}
...
impl FromStr for NTP64 {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        parse_rfc3339(s)
            ...
            .and_then(|time| {
                time.duration_since(*crate::EPOCH)
                    .map_err(|e| ParseNTP64Error {
                        cause: e.to_string(),
                    })
            })
