...
impl NTP64 {
    ...
    /// Returns this NTP64 as a f64 in seconds (since UNIX_EPOCH).
    ///
    /// The decimal part of the f64 is the result of a division of NTP64's the 32-bits part
    /// (which is a fraction of 1 second) by 2^32. As a consequence, the even if resulting f64
    /// seems to have a precision lower than 1 nanosecond, that's not the case. It still have the precision
    /// of the time source (3.5 nanosecond if generated by [`crate::HLC`])
    #[inline]
